...
if(t.mp_shop_info){
var T=t.mp_shop_info.pid||"",A=t.mp_shop_info.outer_id||"";
a=extend({
pid:T,
outer_id:A,
pt:y,
...
for(var T=g.exp_info.exp_value||[],A=!1,w=0,E=0;E<T.length;++E){
var h=T[E]||{};
if(1==h.exp_type&&(w=h.comm_attention_num,A=w>0),2==h.exp_type){
A=!1,w=0;
break;
}
}
g.biz_info.show_comm_attention_num=A,g.biz_info.comm_attention_num=w,f={
...
var D=g.exp_info||{},T=D.exp_id||"",A=D.exp_value||[];
try{
A=JSON.stringify(A);
}catch(w){
A="[]";
...
var i,c,l,u,g=a.type,y=a.url,P=a.rl,v=a.apurl,D=a.ticket,T=a.group_id,A=a.pt,w=o.use_new_protocol;
return i=position.getX(t,"js_material_"+r)+e.offsetX,c=position.getY(t,"js_material_"+r)+e.offsetY,
l=m[0].clientWidth,u=m[0].clientHeight,ad_click(g,y,P,v,n,D,T,_,A,d,s,p,i,c,l,u,o,f,w),
log("[Ad] ad_click: type="+g+", url="+y+", rl="+P+", apurl="+v+", traceid="+n+", ticket="+D+", group_id="+T+", aid="+_+", pt="+A+", pos_type="+d+", ad_engine="+s),
!1;
}
...
A=u[0].clientWidth,w=u[0].clientHeight,ad_click(i,_,n,c,l,m,f,g,y,d,s,p,D,T,A,w,o,v,P),
...
p.adid=window.adid||p.adid||p.aid;
var A=o.exp_info||{},w=A.exp_id||"",E=A.exp_value||[];
try{
E=JSON.stringify(E);
}catch(h){
E="[]";
}
var f="&tid="+p.traceid+"&uin="+uin+"&key="+key+"&ticket="+(p.ticket||"")+"&__biz="+biz+"&source="+source+"&scene="+scene+"&appuin="+biz+"&aid="+p.adid+"&ad_engine="+s+"&pos_type="+d+"&exp_id="+w+"&exp_value="+E+"&r="+Math.random();
