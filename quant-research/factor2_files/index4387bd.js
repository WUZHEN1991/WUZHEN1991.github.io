...
var o=N[e],i=g.attr(o,"data-showed");
if("no"==i){
...
function a(e){
try{
for(var i=window.pageYOffset||document.documentElement.scrollTop,a=window.innerHeight||document.documentElement.clientHeight,m=0;m<N.length;m+=T){
var l=N[m];
if(!(l.offsetTop>i+a+100)){
var w=g.attr(l,"data-cpsstatus");
if("hide"==w){
l.setAttribute("data-cpsstatus","loading");
for(var u=""+m,f=1,h=m+1;h<N.length&&m+T>h;h++)u=u+"%2c"+h,f++;
...
var a=N[e.product_list[i].index],m=e.product_list[i].template_id;
...
try{
var N=document.getElementsByTagName("mpcps");
window.__addIdKeyReport("64469","15",N.length);
for(var K=0;K<N.length;K++){
N[K].setAttribute("data-cpsstatus","hide"),N[K].setAttribute("data-showed","no");
var D={
cps_isready:!1,
cps_state:"",
pid_type:"",
...
source_logo_url:"",
is_ad:1
},M=g.attr(N[K],"data-templateid");
"list"==M?N[K].innerHTML=r.tmpl(p,D):"banner"==M?N[K].innerHTML=r.tmpl(d,D):"card"==M&&(N[K].innerHTML=r.tmpl(s,D));
}
}catch(L){
console.log(L);
}
...
o=o.replace(u,"http://m.qpic.cn"),/^http(s)?:\/\/m\.qpic\.cn([\/?].*)*$/i.test(o)&&!window.webp&&(o=G.addParam(o,"t","",!0)),
o=G.addParam(o,"wx_lazy","1",!0);
...
}(),w("[Appmsg] href:"+location.href+"^^^ ua:"+window.navigator.userAgent),window.addEventListener?window.addEventListener("load",O,!1):window.attachEvent&&window.attachEvent("onload",O),
...
var lt=Math.random();
if(2e-4>lt)try{
for(var wt=document.getElementsByTagName("img"),_t=window.screen.height,gt=window.screen.width,ut=0,ft=window.devicePixelRatio,ut="",K=0,ht=wt.length;ht>K;K++){
var vt=wt[K].getAttribute("data-src");
if(vt){
var yt=wt[K].getBoundingClientRect();
